...
import ru.vsu.cs.iachnyi_m_a.gigaguide.surfsummerschool.database.QuestionDBEntity
...
import ru.vsu.cs.iachnyi_m_a.gigaguide.surfsummerschool.repository.QuizRepository
import ru.vsu.cs.iachnyi_m_a.gigaguide.surfsummerschool.repository.QuizRepositoryRetrofit
...
class HomeScreenViewModel() : ViewModel() {
    ...
    private val quizRepository: QuizRepository = QuizRepositoryRetrofit()
            ...
            try {
                withContext(Dispatchers.IO) {
                    ...
                    if(allQuizzes.isNotEmpty()){
                        id = allQuizzes.maxOfOrNull { it.quiz.id }!!.toInt()
                    }
